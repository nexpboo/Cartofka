...
class Player(GameSprite):
 ...
 def fire(self):
     bullet = Bullet('brick_PNG3326.png', self.rect.right, self.rect.centery, 45, 60, 15)
     bullets.add(bullet)
...
back = (255,255,255)#задаем цвет согласно цветовой схеме RGB
...
w1 = GameSprite('Brickwork_in_Flemish_Bond.jpg',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('Brickwork_in_Flemish_Bond.jpg', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('DerKirpisch.png', 5, win_height - 80, 116, 80, 0, 0)
final_sprite = GameSprite('DerMalen.png', win_width - 150, win_height - 100,156, 80)
 
monster1 = Enemy('che.png', win_width - 80, 70, 100, 150, 5)
monster2 = Enemy('che.png', win_width - 80, 240, 100, 150, 5)
